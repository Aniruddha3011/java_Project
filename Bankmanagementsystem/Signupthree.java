...
public class Signupthree extends JFrame implements ActionListener {
    ...
    Signupthree(String formno) {
       this.formno=formno;
        ...
        JLabel number = new JLabel("XXXX-XXXX-XXXX-" + no);
        number.setFont(new Font("Raleway", Font.BOLD, 22));
        number.setBounds(330, 300, 300, 30);
        add(number);

        JLabel num = new JLabel("Your 16 Digit card Number");
        num.setFont(new Font("Raleway", Font.BOLD, 12));
        num.setBounds(100, 330, 300, 20);
        add(num);
        ...
        JLabel pnum = new JLabel("Your 4 Digit pin Number");
        pnum.setFont(new Font("Raleway", Font.BOLD, 12));
        pnum.setBounds(100, 400, 300, 20);
        add(pnum);

        JLabel services = new JLabel("Services Required: ");
        services.setFont(new Font("Raleway", Font.BOLD, 22));
        services.setBounds(100, 450, 300, 25);
        add(services);
        ...
        cancel.setFont(new Font("Roboto", Font.BOLD, 14));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            long cardnum = Math.abs((random.nextLong() % 90000000L) + 504093600000000L);
            ...
            try {
                if (accountType == null) {
                    ...
                    Conn conn = new Conn();
                    String query1 = "insert into signupthree values('" + formno + "', '" + accountType + "', '" + cardnum + "', '" + pinnumber + "', '" + facility + "')";
